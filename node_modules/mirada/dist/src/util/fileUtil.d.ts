 ...
 */
export declare function readFile(f: string, FS?: import("mirada").FS): ArrayBufferView;
/**
...
export declare function writeFile(name: string, f: ArrayBufferView, FS?: import("mirada").FS): void;
export declare function removeFile(f: string, FS?: import("mirada").FS): void;
export declare function isDir(f: string, FS?: import("mirada").FS): boolean;
export declare function isFile(f: string, FS?: import("mirada").FS): boolean;
