...
const getFilenameFromUrl = require("webpack-dev-middleware/dist/utils/getFilenameFromUrl.js");
...
const {
  ...
  send,
  sendError
} = require("webpack-dev-middleware/dist/utils/compatibleAPI.js");

const ready = require("webpack-dev-middleware/dist/utils/ready.js");
/** @typedef {import("webpack-dev-middleware/dist/index.js").NextFunction} NextFunction */

/** @typedef {import("webpack-dev-middleware/dist/index.js").IncomingMessage} IncomingMessage */

/** @typedef {import("webpack-dev-middleware/dist/index.js").ServerResponse} ServerResponse */
 ...
 * @param {import("webpack-dev-middleware/dist/index.js").Context<Request, Response>} context
 * @return {import("webpack-dev-middleware/dist/index.js").Middleware<Request, Response>}
 */
...
function wrapper(context) {
  return async function middleware(req, res, next) {
    ...
    async function processRequest() {
      /** @type {import("webpack-dev-middleware/dist/utils/getFilenameFromUrl.js").Extra} */
      const extra = {};
