...
/** @typedef {import("webpack-dev-server/node_modules/schema-utils/declarations/validate").Schema} Schema */
...
class Server {
  ...
  static get cli() {
    return {
      get getArguments() {
        return () => require("webpack-dev-server/bin/cli-flags");
      },
      get processArguments() {
        return require("webpack-dev-server/bin/process-arguments");
      },
    };
  }
    ...
    switch (
      ...
      case "string":
        ...
        if (
          ...
          implementation = require("webpack-dev-server/lib/servers/SockJSServer");
        } else if (
          /** @type {WebSocketServerConfiguration} */ (
            this.options.webSocketServer
          ).type === "ws"
        ) {
          implementation = require("webpack-dev-server/lib/servers/WebsocketServer");
        } else {
          try {
