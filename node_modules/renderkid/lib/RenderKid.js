...
inlineStyleApplier = require('renderkid/lib/renderKid/styleApplier/inline');
blockStyleApplier = require('renderkid/lib/renderKid/styleApplier/block');
isPlainObject = require('lodash/isPlainObject');

var _require = require('renderkid/lib/tools');

cloneAndMergeDeep = _require.cloneAndMergeDeep;
AnsiPainter = require('renderkid/lib/AnsiPainter');
Styles = require('renderkid/lib/renderKid/Styles');
Layout = require('renderkid/lib/Layout');
